        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(mobile) || !StringUtils.isMobile(mobile)) {
                    Toast.makeText(MobileRegisterActivity1.this, "请输入正确的手机号码！", Toast.LENGTH_SHORT).show();
                    return;
                }

                progressDialog = ProgressDialog.show(MobileRegisterActivity1.this, null, "正在发送验证码…");
                ...
                final Handler smsHandler = new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        switch (msg.what) {
                            case -1:
                                Toast.makeText(MobileRegisterActivity1.this, "发送验证码失败，请您重试！", Toast.LENGTH_SHORT).show();
                                break;
                            case 0:
                                Toast.makeText(MobileRegisterActivity1.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
                                break;
                            case 1:
                                Intent intent = new Intent(MobileRegisterActivity1.this, MobileRegisterActivity2.class);
                ...
                new Thread() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Log.e("mobile_register", ex.getMessage());
                        }
                        smsHandler.sendEmptyMessage(-1);
                    }
                }.start();
