 ...
 */
public class FindPasswordActivity2 extends Activity{
    ...
    private void sendCode(){
        ...
        if(StringUtils.isEmpty(mobile) || !StringUtils.isMobile(mobile)){
            Toast.makeText(FindPasswordActivity2.this, "请输入正确的手机号码！", Toast.LENGTH_SHORT).show();
            return;
        }

        resendBtn.setEnabled(false);
        progressDialog = ProgressDialog.show(FindPasswordActivity2.this, null, "正在发送验证码…");
        final Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case -1:
                        Toast.makeText(FindPasswordActivity2.this, "发送验证码失败！", Toast.LENGTH_SHORT).show();
                        resendBtn.setEnabled(true);
                        break;
                    case 0:
                        Toast.makeText(FindPasswordActivity2.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
                        resendBtn.setEnabled(true);
                        break;
                    case 1:
                        startTimer();
    ...
    private void next(){
        ...
        progressDialog = ProgressDialog.show(FindPasswordActivity2.this, null, "正在加载…");
        final Handler handler = new Handler() {
            @Override
            public void handleMessage(Message msg) {
                progressDialog.dismiss();
                switch (msg.what) {
                    case -1:
                        Toast.makeText(FindPasswordActivity2.this, "验证码检验失败！", Toast.LENGTH_SHORT).show();
                        break;
                    case 0:
                        Toast.makeText(FindPasswordActivity2.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
                        break;
