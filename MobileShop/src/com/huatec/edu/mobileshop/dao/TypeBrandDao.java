...
public interface TypeBrandDao {
	...
	public List<TypeBrand> findByTypeId(int type_id);
	public List<TypeBrand> findByBrandId(int brand_id);
	public List<TypeBrand> findUnion();
	public TypeBrand findUnionById(int id);
	public List<TypeBrand> findUnionByBrandId(int brand_id);
}
