...
public class GoodsController {
	...
	@RequestMapping(value="/findFromAll",method=RequestMethod.POST)
	@ResponseBody
	@ApiOperation(value="搜索商品（全部商品）")
	public Result search2(@ApiParam(value="分类名称/品牌名称/商品关键字")@RequestParam("input") String input){
		Result result=goodsService.searchGoods2(input);
		return result;
	}
	//根据id更新
